...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="<?php echo base_url('user/barang_rusak');?>">Barang</a></li>
		<li class="active">Rusak</li>
	</ol>
</section>
<!-- Main content -->
  ...
  <div class="row">
      ...
      <div class="box box-info">
        <!-- <div class="box-header pull-right">
          <form action="<?php //echo base_url('user/printBrgRusakPDF'); ?>" method="post">
            <div class="row">
          ...
          <div class="table-responsive">
            <table class="table no-margin" id="dtTable">
              ...
              <tr>
                ...
                <?php if($dataUser['level']==1) { ?>
                <td>
                  <a href="#" class="btn btn-sm btn-success" onclick="konfirmasi2(<?=$value->id_barang_gudang;?>,'<?=$value->kode_barang;?>')" data-toggle="modal" data-target="#modalSetujui">
  ...
  <div class="vertical-alignment-helper">
    <div class="modal-dialog modal-sm vertical-align-center" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p style="text-align:center;font-weight:bold;">
            Apakah anda yakin akan MENGHAPUS data barang dengan kode <span id="kode2"></span> dari gudang ?
          </p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" data-dismiss="modal">
  ...
  <div class="vertical-alignment-helper">
    <div class="modal-dialog modal-sm vertical-align-center" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p style="text-align:center;font-weight:bold;">
          Apakah anda yakin akan mencetak <br>Data Barang Rusak Tahun <span id="tahun"></span> ?
          </p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" data-dismiss="modal">
...
<script type="text/javascript">
  function konfirmasi1(id,kode){
    ...
    $('#validasiYes').attr('href','<?=base_url();?>user/edit_status_gudang/'+id+'/0');
  }
  function konfirmasi2(id,kode){
    $('span#kode2').html(kode);
    $('#tolakYes').attr('href','<?=base_url();?>user/delete_gudang/'+id);
  }
  function kirim(){
    $('#btnCetak').click();
  }
